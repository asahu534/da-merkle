...
export default function decorate(block) {
  ...
  if (!isSingleSlide) {
    ...
    // auto-advance the hero unless the author disables it or the user prefers reduced motion
    ...
    if (autoplay) {
      ...
      block.addEventListener('mouseenter', () => { clearInterval(timer); timer = null; });
